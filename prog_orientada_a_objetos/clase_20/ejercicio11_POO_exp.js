...
function menu() {
    let opc_salida_uno = false, opc_salida_dos = false;
    let opcion_uno, opcion_dos;
    do {
        opcion_uno = prompt(`EMPRESA DE BEBIDAS\n1. Agregar gaseosa\n2. Modificar gaseosa\n3. Borrar gaseosa\n4. Agregar ventas\n5. Modificar venta\n0. SALIR`);
        opcion_uno = parseInt(opcion_uno, 10);
        switch(opcion_uno) {
            case 1:
                agregar_gaseosa();
                break;
    ...
    } while(opc_salida_uno == false);
    cargar_puntos_de_venta();

    do {
        opcion_dos = prompt(`EMPRESA DE BEBIDAS\n1. La gaseosa mas vendida y la menos vendida\n2. Valor promedio de las gaseosas vendidas\n3. Mostrar las ventas realizadas y lo facturado\n4. Mostrar las gaseosas entregadas y el total segun el numero de punto de venta\n5. Mostrar datos completos de los Puntos de Venta\n0. SALIR`);
        opcion_dos = parseInt(opcion_dos, 10);
        switch(opcion_dos) {
            case 1:
                if(bebidas.length == 0){alert(`ERROR\nTenes que ingresar al menos una gaseosa para ingresar a esta opcion`);}
                else if(vec_cant_vendida.length == 0) {alert(`ERROR\nTenes que ingresar la venta de las gaseosas`);
